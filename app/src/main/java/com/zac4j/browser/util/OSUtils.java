...
public class OSUtils {
  ...
  // "LGD857AT-00-V20b-CUO-CN-FEB-17-2015+0"
  // 联想
  ...
  public static String getRomVersion() {
    return String.valueOf(ROM_TYPE.getVersion());
  }
    ...
    try {
      ...
      if (buildProperties.containsKey(KEY_MIUI_VERSION_NANE) || buildProperties.containsKey(
        ...
        if (buildProperties.containsKey(KEY_MIUI_VERSION)) {
          ...
          KEY_EMUI_API_LEVEL) || buildProperties.containsKey(KEY_EMUI_SYSTEM_VERSION)) {
        // EMUI
        rom = ROM.EMUI;
        ...
        if (buildProperties.containsKey(KEY_DISPLAY_ID)) {
          ...
          KEY_COLOROS_THEME_VERSION) || buildProperties.containsKey(KEY_COLOROS_ROM_VERSION)) {
        // ColorOS
        rom = ROM.ColorOS;
        if (buildProperties.containsKey(KEY_COLOROS_ROM_VERSION)) {
          ...
          KEY_FUNTOUCHOS_OS_VERSION) || buildProperties.containsKey(KEY_FUNTOUCHOS_DISPLAY_ID)) {
        // FuntouchOS
        rom = ROM.FuntouchOS;
        if (buildProperties.containsKey(KEY_FUNTOUCHOS_OS_VERSION)) {
          ...
          KEY_EUI_NAME) || buildProperties.containsKey(KEY_EUI_MODEL)) {
        // EUI
        rom = ROM.EUI;
        ...
        rom = ROM.Sense;
          ...
          KEY_LG_SW_VERSION_SHORT) || buildProperties.containsKey(KEY_LG_FACTORY_VERSION)) {
        // LG
        rom = ROM.LG;
      } else if (buildProperties.containsKey(KEY_LENOVO_DEVICE) || buildProperties.containsKey(
          KEY_LENOVO_PLATFORM) || buildProperties.containsKey(KEY_LENOVO_ADB)) {
        // Lenovo
        rom = ROM.Lenovo;
  ...
  public enum ROM {
    ...
    Android; // CyanogenMod, Lewa OS, 百度云OS, Tencent OS, 深度OS, IUNI OS, Tapas OS, Mokee
